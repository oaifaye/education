...
<html>
  <head>
	...
	<script type="text/javascript">
		//分页查询
		function pagerControl(currentPage,educationalCounselingId){
			if(educationalCounselingId!=""){
				document.pageForm.action="fDetaileducationalCounseling.action?state=1&educationalCounselingId="+educationalCounselingId+"&currentPage="+currentPage;
			}
  ...
  <body>
     ...
     <div class="center">
        ...
        <div class="left">
            <div class="news_0  w_738">
           
                <ul class="news_1">
                    <h2><s:property value="educationalCounseling.eduCounselingTitle"/></h2>
					作者：<s:property value="educationalCounseling.author" />
					时间：<s:date name="educationalCounseling.publicDate" format="yyyy-MM-dd" />
                </ul>
                <ul style="width:620px; padding-left:50px;" class="ckepop">
			<div id="bdshare" class="bdshare_t bds_tools get-codes-bdshare">
                ...
                <ul class="news_2">
                   <s:property value="paginationSupport_content.content" escape="false"/>
                </ul>
            </div>
            <%@ include file="../include/front_pageNavigation_content.jsp" %>
        <div class="news_bottom">
		<h2>"高考改革"相关资讯</h2>
		<ul class="dian">
			<li><a target="_blank" title="江苏启动下轮高考改革研究" href="http://nanjing.xueda.com/News/3622.Shtml">江苏启动下轮高考改革研究</a></li><li><a target="_blank" title="沪将依居住证积分办法 研究随迁子女中高考方案" href="http://shanghai.xueda.com/News/3611.Shtml">沪将依居住证积分办法 研究随迁子女中高考...</a></li><li><a target="_blank" title="上海明确暂不试行英语一年多考" href="http://shanghai.xueda.com/News/3597.Shtml">上海明确暂不试行英语一年多考</a></li><li><a target="_blank" title="教育部：高考改革今年定框架" href="http://shanghai.xueda.com/News/3595.Shtml">教育部：高考改革今年定框架</a></li><li><a target="_blank" title="高考改革今年定框架 英语或一年考多次" href="http://jilin.xueda.com/News/3561.Shtml">高考改革今年定框架 英语或一年考多次</a></li>
		</ul>
		<ul  class="dian">
			<li><a target="_blank" title="网传2015年高考方案要改" href="http://changzhou.xueda.com/News/3497.Shtml">网传2015年高考方案要改</a></li><li><a target="_blank" title="教育部:高考将改革 今年搭框架" href="http://guangzhou.xueda.com/News/3478.Shtml">教育部:高考将改革 今年搭框架</a></li><li><a target="_blank" title="“老课堂”受捧应试教育当羞" href="http://nanjing.xueda.com/News/3659.Shtml">“老课堂”受捧应试教育当羞</a></li><li><a target="_blank" title="初中数学复习五大原则" href="http://hefei.xueda.com/News/3658.Shtml">初中数学复习五大原则</a></li><li><a target="_blank" title="高三寒假如何复习" href="http://hefei.xueda.com/News/3657.Shtml">高三寒假如何复习</a></li>
		</ul>
	</div>
        </div>
   <div class="right">
