...
<html>
  <head>
    ...
    <title><s:property value="yiDuiYi.title"/></title>
	...
	<script type="text/javascript" src="js/front_calss_list.js"></script>
  ...
  <%@ include file="../include/front_top.jsp"%>
    <div class="center">
        ...
        <div class="left">
           <div class="box_1  w_738">
                <h1>
                    <span>
                    	<b id="box_5">辅导课程</b></span> <b id="guanzhu">关注度：<img src="<%=basePath %>/images/untitled.png" />
                    </b>
                </h1>
                <ul class="course_1">
                    <span>
                        <img src="imgUpload/<s:property value="yiDuiYi.picName"/>" />
                    </span>
                    <strong class="color_6"><s:property value="yiDuiYi.title"/></strong><br>
                    <b>适合人群：</b><s:property value="yiDuiYi.fitPerson"/><br/>
                    <b>上课时间：</b><s:property value="yiDuiYi.classTime"/><b class="color_4">（具体辅导时间请致电了解）</b><br/>
                    <b>上课地点：</b><a target="_blank" href="/School/Index.Shtml">查看地点</a>
                    <br />
                    <b>咨询热线：</b><s:property value="yiDuiYi.phone"/>
                    <br />
                    <a class="top10" id="zixun" href="javascript:;" onclick="Open()">在线咨询</a>
                    <a class="top10" id="baoming" href="#Course">立即报名</a>
                </ul>
            </div>
            <!--招生简章-->
            ...
            <div class="box_33 w_738" style="display: block;">
                <ul style="padding: 30px 50px 30px 50px;">
                	<li>
                		<s:property value="yiDuiYi.regulations" escape="false"/>
                	</li>
                </ul>
            </div>
    ...
    <div  class="box_3 w_738 top10">
                <ul style="float: left; position: relative">
                    <li class="current"><a name="Course">在线报名</a></li>
                </ul>
                    ...
                    <div class="items">
                        ...
                        <table width="100%" border="0" cellpadding="3" cellspacing="3">
                            ...
                            <tr>
                                ...
                                <td class="r">
                                    <input class="apply_inpW" maxlength="50" id="Email" name="Email" type="text" value="" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="4%" class="r">
                                    <input name="立即报名" type="submit" id="bao_bottom_1" 
                                        value="立即报名" />
                                </td>
                            </tr>
                        </table>
